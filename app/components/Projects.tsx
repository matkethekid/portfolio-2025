    ...
    <div className='flex flex-1 flex-col w-full min-h-screen max-sm:px-0 px-7 bg-transparent py-7 max-w-5xl max-sm:max-w-8xl mx-auto z-20 relative'>
      <div className="px-7">
        ...
        <div className={isProjectOpen ? 'fixed inset-0 flex items-center justify-center z-50' : 'hidden'} onClick={closeProject}>
            <div className="bg-red-500 w-[50%] h-[50%] flex items-center justify-center rounded-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-6 w-full mt-30 px-4">
            {
                projects.map((project, index) => (
                    <div key={index} onClick={() => seeProjectDetails(index)} className="w-full rounded-lg group cursor-pointer bg-gradient-to-br from-emerald-500/60 to-black border border-emerald-500/20 hover:border-emerald-500/80 transition-all duration-300 flex flex-col">
